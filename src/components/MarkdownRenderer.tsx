...
// GitHub Pages project sites are served under a base path (e.g. /llmrix-page/).
// Rewrite root-absolute URLs (/images/..., /post/...) so they resolve inside the base.
    ...
    return (
        <div className={`markdown-body ${className}`.trim()}>
            <ReactMarkdown
                ...
                components={{
                    img: ({ src, alt, ...props }) => <img src={withBase(src)} alt={alt} {...props} />,
                    a: ({ href, children, ...props }) => <a href={withBase(href)} {...props}>{children}</a>,
